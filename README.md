...
E' presente un eseguibile Windows per rendere l'installazione più semplice ed aggiungere in automatico l'eseguibile alla variabile d'ambiente "*PATH*", procedimento altrimenti manuale per coloro che decideranno di installarlo a mano.
